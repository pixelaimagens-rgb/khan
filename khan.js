...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ khanTrampos Failed to Injected!\n\nVocê precisa executar o khanTrampos no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
...
.then(async () => {
    ...
    sendToast("🌿 khanTrampos injetado com sucesso!");
