...
const repoPath = `https://raw.githubusercontent.com/pixelaimagens-rgb/khan/refs/heads/${isDev ? "dev/" : "main/"}`;
...
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { 
    alert("❌ khanTrampos Failed to Injected!\n\nVocê precisa executar o khanTrampos no site do Khan Academy! (https://pt.khanacademy.org/)"); 
